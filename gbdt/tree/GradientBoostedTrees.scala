...
import org.apache.spark.mllib.gbdt.tree.impl.TimeTracker
import org.apache.spark.mllib.gbdt.tree.impurity.Variance
import org.apache.spark.mllib.gbdt.tree.model.{DecisionTreeModel, GradientBoostedTreesModel}
...
object GradientBoostedTrees extends Logging {
  ...
  /**
   * Java-friendly API for [[org.apache.spark.mllib.gbdt.tree.GradientBoostedTrees$#train]]
   */
  @Since("1.2.0")
  def train(
      input: JavaRDD[LabeledPoint],
