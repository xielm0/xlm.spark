...
package org.apache.spark.mllib.gbdt.tree.configuration

import scala.beans.BeanProperty

import org.apache.spark.annotation.{Experimental, Since}
import org.apache.spark.mllib.gbdt.tree.configuration.Algo._
import org.apache.spark.mllib.gbdt.tree.loss.{LogLoss, SquaredError, Loss}

/**
 * :: Experimental ::
 * Configuration options for [[org.apache.spark.mllib.gbdt.tree.GradientBoostedTrees]].
 *
 ...
 *                      [[org.apache.spark.mllib.gbdt.tree.GradientBoostedTrees.run()]] is used.
 */
@Since("1.2.0")
@Experimental
