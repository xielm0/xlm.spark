...
import org.apache.spark.mllib.gbdt.tree.impl.{BaggedPoint, DecisionTreeMetadata, NodeIdCache,
  TimeTracker, TreePoint}
import org.apache.spark.mllib.gbdt.tree.impurity.Impurities
...
object RandomForest extends Serializable with Logging {
  ...
  /**
   * Java-friendly API for [[org.apache.spark.mllib.gbdt.tree.RandomForest$#trainClassifier]]
   */
  @Since("1.2.0")
  def trainClassifier(
  ...
  /**
   * Java-friendly API for [[org.apache.spark.mllib.gbdt.tree.RandomForest$#trainRegressor]]
   */
  @Since("1.2.0")
  def trainRegressor(
      input: JavaRDD[LabeledPoint],
