...
package org.apache.spark.mllib.gbdt.tree.model
...
import org.apache.spark.mllib.gbdt.tree.configuration.Algo
import org.apache.spark.mllib.gbdt.tree.configuration.Algo._
import org.apache.spark.mllib.gbdt.tree.configuration.EnsembleCombiningStrategy._
import org.apache.spark.mllib.gbdt.tree.loss.Loss
...
object RandomForestModel extends Loader[RandomForestModel] {
  ...
  private object SaveLoadV1_0 {
    ...
    def thisClassName: String = "org.apache.spark.mllib.gbdt.tree.model.RandomForestModel"
  }
...
object GradientBoostedTreesModel extends Loader[GradientBoostedTreesModel] {
  ...
  private object SaveLoadV1_0 {
    // Hard-code class name string in case it changes in the future
    def thisClassName: String = "org.apache.spark.mllib.gbdt.tree.model.GradientBoostedTreesModel"
  }
...
private[tree] object TreeEnsembleModel extends Logging {
  ...
  object SaveLoadV1_0 {
    ...
    import org.apache.spark.mllib.gbdt.tree.model.DecisionTreeModel.SaveLoadV1_0.{NodeData, constructTrees}
